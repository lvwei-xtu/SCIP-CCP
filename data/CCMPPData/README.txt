...
- In the file:
  ...
  - Line 3 provides an array of the capital costs per megawatt for coal power plants (that data c_t, t=1,...,T)
  - Line 5 provides an array of the capital costs per megawatt for nuclear power plants (that data n_t, t=1,...,T)
  - Line 7 line provides an array of the electric capacity from existing resources (that data e_t, t=1,...,T)
